...
Source0  : https://github.com/intel/libva-utils/archive/2.18.0/libva-utils-2.18.0.tar.gz
...
%prep
%setup -q -n libva-utils-2.18.0
cd %{_builddir}/libva-utils-2.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679063304
