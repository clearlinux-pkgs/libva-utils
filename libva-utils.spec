...
Version  : 2.16.0
Release  : 26
URL      : https://github.com/intel/libva-utils/archive/2.16.0/libva-utils-2.16.0.tar.gz
Source0  : https://github.com/intel/libva-utils/archive/2.16.0/libva-utils-2.16.0.tar.gz
...
%prep
%setup -q -n libva-utils-2.16.0
cd %{_builddir}/libva-utils-2.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665414284
