...
Version  : 2.15.0
Release  : 25
URL      : https://github.com/intel/libva-utils/archive/2.15.0/libva-utils-2.15.0.tar.gz
Source0  : https://github.com/intel/libva-utils/archive/2.15.0/libva-utils-2.15.0.tar.gz
...
%prep
%setup -q -n libva-utils-2.15.0
cd %{_builddir}/libva-utils-2.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656687567
...
cp %{_builddir}/libva-utils-2.15.0/COPYING %{buildroot}/usr/share/package-licenses/libva-utils/946e6b5d574d506ac5f84e0826d29887b3d5a2f6
cp %{_builddir}/libva-utils-2.15.0/test/gtest/LICENSE %{buildroot}/usr/share/package-licenses/libva-utils/5a2314153eadadc69258a9429104cd11804ea304
%make_install
