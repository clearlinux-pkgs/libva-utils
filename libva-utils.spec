...
Version  : 2.18.1
Release  : 30
URL      : https://github.com/intel/libva-utils/archive/2.18.1/libva-utils-2.18.1.tar.gz
Source0  : https://github.com/intel/libva-utils/archive/2.18.1/libva-utils-2.18.1.tar.gz
...
%prep
%setup -q -n libva-utils-2.18.1
cd %{_builddir}/libva-utils-2.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680012182
